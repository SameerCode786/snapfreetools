...
import { Image, ArrowLeft, FileText, ImageIcon, FileEdit } from "lucide-react";

export const metadata = {
  title: "JPG to PDF Converter - Convert Images to PDF Free",
  description: "Convert JPG, PNG, and image files to PDF online free. Combine multiple pictures into a single PDF document inside your browser.",
  robots: {
    index: false,
    follow: true
  },
  alternates: {
    canonical: "https://www.snapfreetools.com/jpg-to-pdf"
  }
};
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <h1 className="text-2xl font-black text-slate-900">JPG to PDF Converter</h1>
          <p className="text-sm text-slate-500 font-medium max-w-md mx-auto leading-relaxed">
            Convert JPG, PNG, and image files to PDF online. Combine multiple pictures into a single PDF document. This feature is currently under development.
          </p>
        </div>
