...
import { FileDown, ArrowLeft, FileText, ImageIcon, FileEdit } from "lucide-react";

export const metadata = {
  title: "Compress PDF Online - Reduce PDF File Size Free",
  description: "Compress PDF files online free. Reduce PDF document file size while maintaining optimal text and image quality.",
  robots: {
    index: false,
    follow: true
  },
  alternates: {
    canonical: "https://www.snapfreetools.com/compress-pdf"
  }
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <nav className="flex items-center gap-2 text-xs font-semibold text-slate-500 uppercase tracking-wider">
        ...
        <span>/</span>
        <span className="text-slate-800">Compress PDF</span>
      </nav>
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <h1 className="text-2xl font-black text-slate-900">Compress PDF Online</h1>
          <p className="text-sm text-slate-500 font-medium max-w-md mx-auto leading-relaxed">
            Reduce PDF document file size while maintaining optimal quality. This feature is currently under development.
          </p>
        </div>
