...
import { Scissors, ArrowLeft, FileText, ImageIcon, FileEdit } from "lucide-react";

export const metadata = {
  title: "Split PDF Online - Separate PDF Pages Free",
  description: "Split PDF files online free. Separate PDF pages or extract selected pages from your PDF document easily.",
  robots: {
    index: false,
    follow: true
  },
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <nav className="flex items-center gap-2 text-xs font-semibold text-slate-500 uppercase tracking-wider">
        ...
        <span>/</span>
        <span className="text-slate-800">Split PDF</span>
      </nav>
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <h1 className="text-2xl font-black text-slate-900">Split PDF Online</h1>
          <p className="text-sm text-slate-500 font-medium max-w-md mx-auto leading-relaxed">
            Separate pages or extract selected pages from your PDF document easily. This feature is currently under development.
          </p>
        </div>
