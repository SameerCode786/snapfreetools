...
import { LayoutGrid, Upload, ShieldCheck, AlertCircle } from "lucide-react";
        ...
        <div className="space-y-4 flex flex-col items-center">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-sm font-semibold text-slate-500 max-w-md mx-auto">
              Reorder, sort, and arrange PDF pages visually with drag-and-drop. 100% private & processed in your browser.
            </p>
          </div>
