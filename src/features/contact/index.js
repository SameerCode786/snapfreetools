    ...
    <div id="contact-page" className="max-w-4xl mx-auto px-4 py-16">
      ...
      >
        <div className="bg-primary p-12 text-white">
          ...
          <p className="mb-10 text-emerald-50 leading-relaxed">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-emerald-100 uppercase font-bold tracking-widest">Email Us</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-emerald-100 uppercase font-bold tracking-widest">Support</p>
        ...
        <div className="p-12">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full bg-primary text-white py-4 rounded-xl font-bold hover:bg-primary-dark transition-all shadow-lg shadow-emerald-100"
              >
                Send Message
              </button>
            </form>
