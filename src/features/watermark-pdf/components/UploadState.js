...
import { Stamp, Upload, ShieldCheck, AlertCircle } from "lucide-react";
        ...
        <div className="space-y-4 flex flex-col items-center">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-sm font-semibold text-slate-500 max-w-md mx-auto">
              Add text or logo image watermarks to your PDF pages online for free. 100% private & processed in your browser.
            </p>
          </div>
