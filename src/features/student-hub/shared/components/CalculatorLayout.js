      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <aside className="lg:col-span-3 space-y-8">
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-200 text-center min-h-[250px] flex flex-col justify-center items-center">
            ...
            <div className="w-full h-48 bg-slate-50 border border-dashed border-slate-200 rounded-2xl flex items-center justify-center text-slate-300 text-xs font-semibold">
              Ad Banner Slot
            </div>
          </div>
              ...
              {relatedCalculators.map((calc) => {
                ...
                return (
                  <li key={calc.slug}>
                    <Link 
                      href={`/${calc.slug}`} 
                      className="flex items-center gap-3 p-2.5 rounded-xl text-slate-600 hover:text-amber-600 hover:bg-amber-50/50 border border-transparent hover:border-amber-100 transition-all text-sm font-semibold group"
                    >
                      <div className="w-7 h-7 rounded-lg bg-slate-50 group-hover:bg-amber-50 flex items-center justify-center text-slate-500 group-hover:text-amber-600 transition-colors">
