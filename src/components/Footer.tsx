      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="text-white text-2xl font-bold mb-4 block">
              FastFreeTools
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/word-counter" className="hover:text-white">Word Counter</Link></li>
              <li><Link to="/image-compressor" className="hover:text-white">Image Compressor</Link></li>
              <li><Link to="/gpa-calculator" className="hover:text-white">GPA Calculator</Link></li>
              <li><Link to="/pdf-to-word" className="hover:text-white">PDF to Word</Link></li>
            </ul>
          </div>
        </div>
