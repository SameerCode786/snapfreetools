...
export default function Home() {
  useEffect(() => {
    document.title = "SnapFreeTools - Free Online Productivity Tools";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "SnapFreeTools provides a collection of clean, fast, and secure tools to help you get your work done faster. Word counter, image compressor, and more.");
    }
  }, []);
