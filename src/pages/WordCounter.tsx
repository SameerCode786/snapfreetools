...
export default function WordCounter() {
  ...
  useEffect(() => {
    document.title = "Word Counter – Count Words Online | SnapFreeTools";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Instantly count words, characters, and sentences in your text with reading time estimation. Free online tool for writers and students.");
    }
  }, []);
  ...
  return (
    <div id="word-counter-page" className="max-w-4xl mx-auto px-4 py-12">
      <motion.div 
